...
plt.plot(us_fac_ssdu, loss_ssdu, '1', markersize=10)
...
plt.plot(us_fac_ssdu, SSIM_ssdu, '1', markersize=10)
plt.plot(us_fac_unw, SSIM_unw, '2', markersize=10)
plt.plot(us_fac_w, SSIM_w, '3', markersize=10)
plt.ylabel('SSIM')
plt.xlabel('acceleration of second mask')
# plt.ylim((0.5, 1))
plt.legend(['Fully sampled benchmark',  'SSDU', 'Unweighted', 'Weighted'])
plt.title('')
plt.show()